...
Public Class FrmAdmission
    ...
    Public Sub New(darkmode As String)
    ...
    Private Sub btn_Click(sender As Object, e As EventArgs) Handles btnFacultyMembers.Click, btnEnrollment.Click, btnAttendance.Click
        ...
        Select Case sender.name
            ...
            Case "btnAttendance"
                Dim frm As New FrmSelectClass("Class Register", _darkMode)
                frm.ShowDialog()

            Case "btnEnrollment"
                Dim frm As New FrmEnrollment(_darkMode)
                frm.Show()

            Case "btnFacultyMembers"
                Dim frm As New FrmFaculty(_darkMode, 0)
                frm.Show()
        End Select
